        ...
        <main className="min-h-screen bg-background flex items-center justify-center px-4 py-32">
          <div className="max-w-md w-full text-center">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-8">
              Thank you for applying to DeployUp. We have received your application and will review it carefully. If your profile matches our requirements, our team will reach out to you within 7 business days.
            </p>
